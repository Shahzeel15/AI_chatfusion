...
"PDF","Voice","CSV","Text","Video","Translator","Image","PPT","Visual","URL","Audio","Fuzzy"
])
...
if page=="PDF":
       ...
       # User selection for task'
       tabs = st.tabs( ["PDF Generation", "Search In PDF","Chat with PDF","Merge PDF","Replace in PDF"])
       ...
       with tabs[0]:
           ...
           def create_pdf(topic, sub_titles, final_content):
               ...
               pdf.output(f"D:\8thsem\document_{topic}.pdf")
           ...
           if submit:
               ...
               download_button(f"D:\8thsem\document_{topic}.pdf", topic)
...
if page=="PPT":
   ...
   # pip install python-pptx
      ...
      if submit:
          ...
          powerpoint.save(f"D:\last\Powerpoint\{topic}.pptx")
          st.text("PPT Created Successfully")
          download_button(f"D:\last\Powerpoint\{topic}.pptx",topic)
          print("DONE finally ")
...
# Additional design elements in the sidebar
           st.sidebar.title("Customization Options")

# Color scheme customization with improved display
           color_schemes = {
                "Default": ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22",
                 "#17becf"],
                "Light": ["#f0f0f0", "#d9d9d9", "#bdbdbd", "#969696", "#737373", "#525252", "#252525"],
                "Dark": ["#2b2b2b", "#333333", "#4c4c4c", "#595959", "#737373", "#8c8c8c", "#a6a6a6", "#bfbfbf", "#d9d9d9",
              "#f0f0f0"],
            }

# color_scheme = st.sidebar.selectbox("Select Color Scheme", list(color_schemes
...
if page=="Voice":
     ...
     def get_audio():
         ...
         with sr.Microphone() as source:
             st.subheader(":blue [Voice Assistant]")
             ...
             st.image("images.jpeg", width=100)  # Add a microphone icon
